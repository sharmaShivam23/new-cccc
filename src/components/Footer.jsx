  ...
  return (
    <div className="sm:h-screen h-[120vh] w-screen bg-black overflow-hidden relative">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-white text-center px-4">
        ...
        <p className="text-white text-3xl md:text-5xl font-bold">Cloud Computing</p>
        ...
        <div className="text-white z-50 text-xl md:text-xl mt-4 font-bold">
          <ShimmerButton className="cursor-pointer hover:scale-125 transition-all ease-in-out duration-1000 delay-0">Start Now</ShimmerButton>
        </div>
      </div>
