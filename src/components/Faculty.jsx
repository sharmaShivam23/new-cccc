  ...
  return (
    <div className="sm:max-w-[90vw] sm:mb-28 lg:mb-3 mt-20 sm:mt-0 m-auto w-full text-white lg:h-screen flex justify-center items-center h-auto bg-green-">
      <div className="flex justify-center max-[450px]:w-[90vw] rounded-3xl flex-col   bg-neutral-800 items-center border-2 p-1 sm:p-5  border-white w-[80vw] sm:w-[70vw] xl:w-[80vw] h-auto lg:h-[75vh]">
        ...
        <div className="flex justify-evenly rounded-3xl gap-10 flex-col lg:flex-row items-center p-3 sm:p-5 pt-0 mt-3 border-white w-auto sm:w-[70vw] xl:w-[80vw] h-auto lg:h-[60vh]">
          <motion.div
          ...
          >
            ...
            <div className="conte text-center mt-4">
              <h1 className="sm:text-3xl text-xl font-[550] text-white">
                Assistant Professor. IT Dept
              </h1>
              <p className="sm:text-xl text-md mt-3 font-[500] text-white">
          ...
          >
            <img
              src={shikha}
              className="sm:h-80 h-56 max-[450px]:h-40 rounded- object-cover"
              alt=""
            />
            <div className="conte text-center mt-4">
              <h1 className="sm:text-3xl text-xl  font-[550] text-white">
