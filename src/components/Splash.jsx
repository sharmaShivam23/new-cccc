  ...
  return (
    ...
    <Particles className='z-50'/>
      <div className='bg-violet-500 h-screen w-screen relative flex justify-center items-center flex-col'>
        <motion.div  initial={{   rotate: 0, scale: 0 }} whileInView={{  rotate: 360, scale: 1 }} transition={{ duration: 4, ease: "easeOut" }} className='z-50' >
        ...
        <div className="ani z-40 bg-black text-3xl absolute text-white flex justify-center items-start">
          <motion.div initial={{height : 0}} whileInView={{height : '100vh'}}  transition={{duration : 4 , ease : 'easeInOut'}}   className='bg-black z-40  w-screen'></motion.div>
        </div>
      </div>
    </>
  );
