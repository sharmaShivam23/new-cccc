...
export const TeamCards = () => {
  ...
  return (
    <div className="max-w-[90vw] m-auto">
      ...
      <Buttons onSelectYear={handleYearSelect} />
...
const Buttons = ({ onSelectYear }) => {
  return (
    <div className="flex justify-evenly">
    <div className="max-w-[90vw] sm:mt-10 mt-5 text-xs sm:text-lg m-auto block sm:flex justify-evenly mb-6">
      <ShimmerButton className=" sm:mt-0  mr-0 sm:mr-16"  onClick={() => onSelectYear('four')}>4th Year</ShimmerButton>
      <ShimmerButton className="mt-5 sm:mt-0  mr-0 sm:mr-16"  onClick={() => onSelectYear('three')}>3rd Year</ShimmerButton>
      <ShimmerButton  className="mt-5 sm:mt-0  mr-0 sm:mr-16" onClick={() => onSelectYear('two')}>2nd Year</ShimmerButton>
    </div>
    </div>
  );
};
            ...
            <div className="relative w-[20rem] cursor-pointer h-[25rem] overflow-hidden border-2 border-[#6E45AC] bg-white rounded-3xl hover:rounded-none group">
              ...
              <div className="w-full img h-full flex justify-center items-center flex-col transform group-hover:translate-x-full   transition-all damber-500">
                ...
                <div className="mt-6 text-center">
                  ...
                  <img src={card2bg} className="w-full absolute bottom-0 left-0" alt="" />
            ...
            <div className="relative w-[20rem]  cursor-pointer h-[25rem] overflow-hidden border-2 border-cyan-400 bg-white rounded-2xl group">
              ...
              <div className="w-full img h-full flex justify-center items-center flex-col transition-all damber-500">
                ...
                <div className="mt-6 text-center">
                  ...
                  <img src={card3bg} className="w-full absolute bottom-0 left-0" alt="" />
                </div>
              </div>
            ...
            <div className="relative w-[20rem]  cursor-pointer h-[25rem] overflow-hidden border-2 border-amber-500 bg-white rounded-2xl group">
              ...
              <div className="w-full img h-full flex justify-center items-center flex-col transition-all damber-500">
                ...
                <div className="mt-6 text-center">
                  ...
                  <img src={cardbg1} className="w-full absolute bottom-0 left-0" alt="" />
                </div>
              </div>
